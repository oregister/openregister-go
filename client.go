...
func DefaultClientOptions() []option.RequestOption {
	...
	if o, ok := os.LookupEnv("OPENREGISTER_API_KEY"); ok {
		defaults = append(defaults, option.WithAPIKey(o))
	}
	if o, ok := os.LookupEnv("OPENREGISTER_CUSTOM_HEADERS"); ok {
...
// environment (OPENREGISTER_API_KEY, OPENREGISTER_BASE_URL). The option passed in
