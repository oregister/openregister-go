...
```sh
go get -u 'github.com/oregister/openregister-go@v0.0.1-alpha.0'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/oregister/openregister-go/option).
