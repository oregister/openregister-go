...
type JobDocumentGetResponse struct {
	...
	Status JobDocumentGetResponseStatus `json:"status" api:"required"`
...
type JobDocumentNewParams struct {
	...
	DocumentCategory JobDocumentNewParamsDocumentCategory `json:"document_category,omitzero" api:"required"`
	paramObj
}
