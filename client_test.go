...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Search.FindCompanies(context.Background(), openregister.SearchFindCompaniesParams{})
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Search.FindCompanies(context.Background(), openregister.SearchFindCompaniesParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Search.FindCompanies(cancelCtx, openregister.SearchFindCompaniesParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Search.FindCompanies(deadlineCtx, openregister.SearchFindCompaniesParams{})
		if err == nil {
