...
func (r *InsolvencyService) GetDetailsV1(ctx context.Context, insolvencyID string, opts ...option.RequestOption) (res *InsolvencyGetDetailsV1Response, err error) {
...
type InsolvencyGetDetailsV1Response struct {
	...
	Events []InsolvencyGetDetailsV1ResponseEvent `json:"events" api:"required"`
...
func (r InsolvencyGetDetailsV1Response) RawJSON() string { return r.JSON.raw }
func (r *InsolvencyGetDetailsV1Response) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// A single published event of an insolvency proceeding, derived from an official
// court publication.
type InsolvencyGetDetailsV1ResponseEvent struct {
	// Unique identifier of the event.
	ID string `json:"id" api:"required" format:"uuid"`
	// Structured details extracted from the publication, where available.
	Details InsolvencyGetDetailsV1ResponseEventDetails `json:"details" api:"required"`
...
// Returns the unmodified JSON received from the API
func (r InsolvencyGetDetailsV1ResponseEvent) RawJSON() string { return r.JSON.raw }
func (r *InsolvencyGetDetailsV1ResponseEvent) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// Structured details extracted from the publication, where available.
type InsolvencyGetDetailsV1ResponseEventDetails struct {
	InsolvencyGrounds       []string                                            `json:"insolvency_grounds" api:"required"`
	Meetings                []InsolvencyGetDetailsV1ResponseEventDetailsMeeting `json:"meetings" api:"required"`
	AdministratorAddress    string                                              `json:"administrator_address" api:"nullable"`
	AdministratorName       string                                              `json:"administrator_name" api:"nullable"`
...
// Returns the unmodified JSON received from the API
func (r InsolvencyGetDetailsV1ResponseEventDetails) RawJSON() string { return r.JSON.raw }
func (r *InsolvencyGetDetailsV1ResponseEventDetails) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// A creditor meeting or hearing announced in the publication.
type InsolvencyGetDetailsV1ResponseEventDetailsMeeting struct {
...
// Returns the unmodified JSON received from the API
func (r InsolvencyGetDetailsV1ResponseEventDetailsMeeting) RawJSON() string { return r.JSON.raw }
func (r *InsolvencyGetDetailsV1ResponseEventDetailsMeeting) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
